...
Source0  : https://files.pythonhosted.org/packages/a2/6e/371856a3fb9d31ca8dac321cda606860fa4548858c0cc45d9d1d4ca2628b/mypy_extensions-1.1.0.tar.gz
...
%prep
%setup -q -n mypy_extensions-1.1.0
cd %{_builddir}/mypy_extensions-1.1.0
pushd ..
cp -a mypy_extensions-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745347331
